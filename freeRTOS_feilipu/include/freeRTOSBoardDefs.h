...
#define I2C_PORT_DIR		DDRC
#define I2C_PORT_STATUS		PINC
#define I2C_BIT_SDA			_BV(PINC4)
#define I2C_BIT_SCL			_BV(PINC5)

// SPI pins
#define SPI_PORT			PORTB
#define SPI_PORT_DIR		DDRB
#define SPI_PORT_PIN		PINB
#define SPI_BIT_SCK			_BV(PINB5)
#define SPI_BIT_MISO		_BV(PINB4)
#define SPI_BIT_MOSI		_BV(PINB3)
#define SPI_BIT_SS			_BV(PINB2)

#define SPI_BIT_SS_WIZNET	_BV(PINB2)	// added for Wiznet 5100/5200 support with SS on PB2 (Pin 10)

#define SPI_PORT_SS_G2		PORTB
#define SPI_PORT_DIR_SS_G2	DDRB
#define SPI_PORT_PIN_SS_G2	PINB
#define SPI_BIT_SS_G2		_BV(PINB0)	// added for Gameduino2 using FTDI FT800 Graphics (Pin 8)

#define SPI_PORT_SS_SD		PORTD
#define SPI_PORT_DIR_SS_SD	DDRD
#define SPI_PORT_PIN_SS_SD	PIND
#define SPI_BIT_SS_SD		_BV(PIND4)	// added for SD Card support with SS on PD4 (Pin 4)

...
#define _LCD_ROWS		2		/* Number of Rows (1,2 or 4). -> Retrograde v2 Project uses  4 else Freetronics use  2 */
#define _LCD_COLS		16		/* Number of Columns (8..40). -> Retrograde v2 Project uses 20 else Freetronics use 16 */

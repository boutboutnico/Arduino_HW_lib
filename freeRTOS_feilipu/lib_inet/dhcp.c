...
static TickType_t start_dhcp_time, next_dhcp_time;	/**< DHCP Timer tick count */
	...
	)
{
	...
	*((uint32_t*)dhcp_real_sip) = 0;
	...
	strncpy((char*)&(pRIPMSG->OPT[i]),HOST_NAME, strlen(HOST_NAME));
